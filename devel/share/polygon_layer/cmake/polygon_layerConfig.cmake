...
if("TRUE" STREQUAL "TRUE")
  set(polygon_layer_SOURCE_PREFIX /home/tim/Dokumente/Git/ros_tests/src/frontier_exploration/polygon_layer)
  set(polygon_layer_DEVEL_PREFIX /home/tim/Dokumente/Git/ros_tests/devel)
  ...
  set(polygon_layer_INSTALL_PREFIX /home/tim/Dokumente/Git/ros_tests/install)
...
if(NOT "/home/tim/Dokumente/Git/ros_tests/src/frontier_exploration/polygon_layer/include;/usr/include " STREQUAL " ")
  set(polygon_layer_INCLUDE_DIRS "")
  set(_include_dirs "/home/tim/Dokumente/Git/ros_tests/src/frontier_exploration/polygon_layer/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'polygon_layer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'polygon_layer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/Dokumente/Git/ros_tests/src/frontier_exploration/polygon_layer/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${polygon_layer_dep}_FOUND)
      find_package(${polygon_layer_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${polygon_layer_dep} REQUIRED ${depend_list})
  endif()
